...
function taskToApi(t) {
  return {
    ...
    reporte: t.reporte, factura: t.factura, motivoNoFactura: t.motivoNoFactura || null, team: t.team || [],
...
function apiToTask(r) {
  ...
  return {
    ...
    notas: r.notas, reporte: r.reporte, factura: r.factura, motivoNoFactura: r.motivo_no_factura || null, team: r.team || [],
