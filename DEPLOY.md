...
| `tareas-equipo.html` | Bump `informes.js?v=20260801f` y `tareas.js?v=20260801a`; checkbox `#show-archivado` renombrado a `#incluir-archivados` con label "Incluir archivados" |
